...
void  graficarGNUPLOT(){
  ...
  fprintf(pipe, "plot '0.0.txt' ti '0.0.txt'\n");
  fprintf(pipe, "replot '0.3.txt' ti '0.3.txt'\n");
  fprintf(pipe, "replot '0.6.txt' ti '0.6.txt'\n");
  fprintf(pipe, "replot '0.9.txt' ti '0.9.txt'\n");
  fprintf(pipe, "replot '1.2.txt' ti '1.2.txt'\n");
  fprintf(pipe, "replot '1.5.txt' ti '1.5.txt'\n");
  fprintf(pipe, "replot '1.8.txt' ti '1.8.txt'\n");
  fprintf(pipe, "replot '2.1.txt' ti '2.1.txt'\n");
  fprintf(pipe, "replot '2.4.txt' ti '2.4.txt'\n");
  fprintf(pipe, "replot '2.7.txt' ti '2.7.txt'\n");
  fprintf(pipe, "replot '3.0.txt' ti '3.0.txt \n");
  fprintf(pipe, "exit '\n");
  close(pipe);
}
